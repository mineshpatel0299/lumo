        ...
        <div className="relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-white leading-tight mb-4">
              The next generation of project management is here.
            </h2>
            <p className="text-zinc-400 text-lg">
              Streamline your workflow, collaborate in real-time, and ship faster with Lumo&apos;s AI-powered engine.
            </p>
          </motion.div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        >
          ...
          <div className="mb-8 hidden lg:block">
            <h2 className="text-3xl font-bold tracking-tight text-text-primary">Sign In</h2>
            <p className="text-text-tertiary mt-2">Welcome back! Please enter your details.</p>
          </div>
